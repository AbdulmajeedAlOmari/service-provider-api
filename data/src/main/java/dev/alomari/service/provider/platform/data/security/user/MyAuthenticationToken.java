...
public abstract class MyAuthenticationToken implements Authentication, CredentialsContainer {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof MyAuthenticationToken)) {
            return false;
        } else {
            MyAuthenticationToken test = (MyAuthenticationToken)obj;
